...
// Programaciï¿½n genï¿½rica (metaprogramaciï¿½n)
...
cadena resul [] = {"Domingo","Lunes","Martes","Miï¿½rcoles","Jueves","Viernes","Sï¿½bado"};
...
#define Gr_empiezaLineas()                  Gr_empieza(GL_LINE_STRIP)           // Vï¿½rtices conectados por lï¿½neas
#define Gr_empiezaLineasCerradas()          Gr_empieza(GL_LINE_LOOP)            // Vï¿½rtices conectados por lï¿½neas mï¿½s la ï¿½ltima con la primera
#define Gr_lineaDePuntos(bitX16)            glLineStipple(1,bitX16)             // Patrï¿½n de dibujo de la lï¿½nea
#define Gr_anchoLinea(ancho)                glLineWidth(ancho)                  // Ancho de la linea
#define Gr_HabLineaDePuntos()               Gr_habilita(GL_LINE_STIPPLE)
#define Gr_empiezaTriangulos()              Gr_empieza(GL_TRIANGLES)            // Triplas de vï¿½rtices definiendo triï¿½ngulos
#define Gr_empiezaTriangulosConectados()    Gr_empieza(GL_TRIANGLE_STRIP)       // Triï¿½ngulos conectados
#define Gr_empiezaVentilador()              Gr_empieza(GL_TRIANGLE_FAN)         // Triï¿½ngulos conectados como aspas de un ventilador
#define Gr_empiezaCuadrilateros()           Gr_empieza(GL_QUADS)                // Cuatriplas definiendo cuadrilï¿½teros
#define Gr_empiezaCuadrilaterosConectados() Gr_empieza(GL_QUAD_STRIP)           // Cuadrilï¿½teros conectados
#define Gr_empiezaPoligonos()               Gr_empieza(GL_POLYGON)              // Polï¿½gono
