...
// Memoria dinÃ¡mica
#define vector(tipo)                        vector<tipo>
#define matriz2D(tipo)                      vector<vector<tipo>>
#define matriz3D(tipo)                      vector<vector<vector<tipo>>>
#define insertaEleVDim(vec,valor)           {auto it = vec.begin(); vec.insert(it,(valor));}
#define intercalaEleVDim(vec,valor,pos)     vec.emplace(vec.begin()+(pos),(valor))
#define agregaEleVDim(vec,valor)            {auto it = vec.end(); vec.insert(it,(valor));}
