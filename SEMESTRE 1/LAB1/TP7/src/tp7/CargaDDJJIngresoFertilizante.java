...
public class CargaDDJJIngresoFertilizante {
    ...
    public static void main(String[] args) {
        ...
        while(true){
            ...
            DDJJFertilizanteIngresoDetalle detalle = new DDJJFertilizanteIngresoDetalle();
            detalle.setCantidadEnvases(cantidadFert);
            detalle.setCapacidadEnvase(capacidad);
            detalle.setCodigoFertilizante(fertilizanteEncontrado[0]);
            detalle.setNombreFertilizante(fertilizanteEncontrado[1]);
            detalle.setSubtotal(subTotal);
            detalle.setTipoEnvase(tipoEnvase);
            
            ddjj.addDetalleFertilizante(detalle);
    ...
    private static void imprimirDDJJ(DDJJIngresoFertilizante ddjj){
        ...
        for(int i=0; i < ddjj.getDetalleFertilizante().size(); i++){
            System.out.println(completarConEspacios(ddjj.getDetalleFertilizante().get(i).getCodigoFertilizante() + "\t " + completarConEspacios(ddjj.getDetalleFertilizante().get(i).getNombreFertilizante()) + " \t "
                    + completarConEspacios(ddjj.getDetalleFertilizante().get(i).getTipoEnvase()) + " \t " + completarConEspacios(Double.toString(ddjj.getDetalleFertilizante().get(i).getCapacidadEnvase())) + " \t "
                    + completarConEspacios(Integer.toString(ddjj.getDetalleFertilizante().get(i).getCantidadEnvases()))) + " \t " + completarConEspacios(Double.toString(ddjj.getDetalleFertilizante().get(i).getSubtotal())) + "");
        }
        System.out.println("--------------------------------------------------------");
