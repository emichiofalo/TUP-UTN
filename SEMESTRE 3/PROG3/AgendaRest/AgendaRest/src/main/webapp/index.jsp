...
<html>
    ...
    <body onload="getContactos()">
        ...
        <div id="listaEmpleados" class="container text-center">
            <%
                ...
                %>
                <div class="row">
                    <div class="col"><% //String.valueOf(a.getId()); %> </div>
                    <div class="col"><% //String.valueOf(a.getId()); %> </div>
                    <div class="col"><% //String.valueOf(a.getId()); %> </div>
                    <div class="col"><% //String.valueOf(a.getId()); %> </div>
                    <div class="col"><% //String.valueOf(a.getId()); %> </div>
                    <div class="col" style="cursor:pointer; color:green">Editar</div>
                    <div class="col" style="cursor:pointer; color:red">Eliminar</div>
                    </div>
                <%
                //}
            %>
