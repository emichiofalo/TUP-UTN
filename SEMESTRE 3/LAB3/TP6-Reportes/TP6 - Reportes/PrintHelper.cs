...
namespace ReporteItext
{
    public class PrintHelper
    {
        ...
        public iTextSharp.text.Document pdfCreateDocument(string docName, string Creator, string Author, string Subject, string Title)
        {
            ...
            {
                Console.Write("Document exception creating PDF document: " + de.ToString());
                return (null);
            }
            catch (IOException ioe)
            {
                Console.Write("I/O exception creating PDF document: " + ioe.ToString());
                return (null);
            }
            catch (Exception exc)
            {
                Console.Write("Exception creating PDF document:" + exc.ToString());
                return (null);
            }
        }
        ...
        public void ShowDocument(string docName)
        {
            ...
            {
                Console.Write("Cannot start process: " + e.ToString());
            }
            myProcess.Dispose();
        }
